      ...
      <div class="content">
        ...
        <div class="info">
          <div class="height piece">
            ...
            <button type="button" v-clipboard:copy="address" v-clipboard:success="onCopy">复制</button>
          </div> 
          <div class="status piece"><span>名称</span> <span class="center">21312312</span></div>
          <div class="time piece"><span>转账</span> <span class="low center">↓324234</span><span class="high center">↑234442</span> </div>
          <div class="hash piece"><span>余额</span> <span class="center">234124141214TRX</span></div>
        </div>
        <div class="title">转账</div>
        <div class="table">
          <div class="th">
            <div class="list">哈希值</div>
            <div class="list">年龄</div>
            <div class="list">发送人</div>
            <div class="list">接受人</div>
            <div class="list">数量</div>
          </div>
          <div class="td th">
