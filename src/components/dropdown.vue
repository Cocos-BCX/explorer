<template>
    <div class="btn-group">
        <li @click="toggleMenu()" class="dropdown-toggle languag" :class="setClass()" v-if="language.name !== undefined">
          {{ language.name }}
          <span class="icon" :class="setClass()"></span>
        </li>

        <li @click="toggleMenu()" class="dropdown-toggle language" :class="setClass()" v-if="language.name === undefined">
          {{placeholderText}}
          <span class="icon" :class="setClass()"></span>
        </li>
